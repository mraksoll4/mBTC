...
// File: internal/BteSwapAssetV2.sol

pragma solidity ^0.5.0;



contract BteSwapAssetV2 is ERC20, ERC20Detailed {
    ...
    constructor() public ERC20Detailed("ANY Bitweb", "aBTE", 8) {
    ...
    function verifyBindAddr(string memory bindaddr) pure internal {
        ...
        byte ch4 = bytes(bindaddr)[4];

        if (ch == 'E' || ch == 'D') {
            require(length <= 34, "mainnet address length is too long");
        } else if (ch4 == '1' && ch == 'w' && ch2 == 'e' && ch3 == 'b') {
